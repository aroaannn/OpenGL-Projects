...
uniform vec2 resolution; // 1000 - 1000
...
void main()
{
  ...
  float sin = 0.5*cos(uv.x  * 10 + 0.5) + 0.5;

  col = vec3(sin,uv.y,1 - uv.x);
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(1000, 1000, "[Background] - [Sinusoidal Waves]", NULL, NULL);
